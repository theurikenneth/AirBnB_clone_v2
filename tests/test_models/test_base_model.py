...
class TestBaseModel(unittest.TestCase):
    ...
    def test_base_model_id_is_string(self):
        ...
        is correctly generated and has the proper format.
        """
        bm = BaseModel()
    ...
    def test_base_model_uuid_good_format(self):
        """
        Tests if UUID is in correct format.
        """
        bm = BaseModel()
    ...
    def test_creation_from_dictionary_basic(self):
        """This function proves ina basic way that when instantiating
        by passing a dictionary, it works coreectly"""
        date = datetime.now()
